class Game extends React.Component {
    ...
    handleSegmentSelect(Id) {
        ...
        if (win != "") {
            ...
            this.setState({message: newMessage, moves: newMoves, player: newPlayer, gameOver: true});
        }
    }
    ...
    newGame() {
        ...
        this.setState({moves: newMoves, player: newPlayer, segments: newSegments, message: "", gameOver: false});
    }
        ...
        if (this.state.gameOver) {
            return (
                <div>
                    ...
                    <button class="ui button" onClick={this.newGame}>New Game</button>
                </div>
            );
        }
